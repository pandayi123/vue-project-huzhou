      ...
      <div class="header-section">
        ...
        <div class="wendu_shidu">
          <div class="status-item" style="display: flex; align-items: center; gap: 0.08rem">
            ...
            <span style="font-weight: 500">{{timerStore.temperature}}℃</span>
          </div>
          ...
          <div class="status-item" style="display: flex; align-items: center; gap: 0.08rem">
            ...
            <span style="font-weight: 500">{{timerStore.humidity}}%</span>
          </div>
          <!-- 新增网络状态 -->
          <div class="separator" style="width: 1px; height: 0.3rem; background: rgba(255, 255, 255, 0.3)"></div>
          <div class="status-item" style="display: flex; align-items: center; gap: 0.08rem">
            <svg class="icon" viewBox="0 0 1024 1024" width="0.3rem" height="0.3rem" style="flex-shrink: 0">
              <path
                d="M960 416H704c-17.6 0-32 14.4-32 32s14.4 32 32 32h256c17.6 0 32-14.4 32-32s-14.4-32-32-32zM832 544H704c-17.6 0-32 14.4-32 32s14.4 32 32 32h128c17.6 0 32-14.4 32-32s-14.4-32-32-32zM576 416H64c-17.6 0-32 14.4-32 32s14.4 32 32 32h512c17.6 0 32-14.4 32-32s-14.4-32-32-32zM448 544H64c-17.6 0-32 14.4-32 32s14.4 32 32 32h384c17.6 0 32-14.4 32-32s-14.4-32-32-32zM960 672H64c-17.6 0-32 14.4-32 32s14.4 32 32 32h896c17.6 0 32-14.4 32-32s-14.4-32-32-32zM320 288H64c-17.6 0-32 14.4-32 32s14.4 32 32 32h256c17.6 0 32-14.4 32-32s-14.4-32-32-32z"
                fill="#ffffff" />
            </svg>
            <span style="font-weight: 500">{{ timerStore.network_status ? '在线' : '离线'}}</span>
          </div>
          ...
          <div class="status-item" style="display: flex; align-items: center; gap: 0.08rem">
            <svg class="icon" viewBox="0 0 1024 1024" width="0.3rem" height="0.3rem" style="flex-shrink: 0">
              <path
                d="M832 320h-64V192c0-70.4-57.6-128-128-128H384c-70.4 0-128 57.6-128 128v128h-64c-17.6 0-32 14.4-32 32v512c0 70.4 57.6 128 128 128h512c70.4 0 128-57.6 128-128V352c0-17.6-14.4-32-32-32zM320 192c0-35.2 28.8-64 64-64h256c35.2 0 64 28.8 64 64v128H320V192zm512 672c0 35.2-28.8 64-64 64H256c-35.2 0-64-28.8-64-64V384h640v480zM416 768V576l-96 96-32-32 128-128 128 128-32 32-96-96v192h-64z"
                fill="#ffffff" />
            </svg>
            <span style="font-weight: 500">{{timerStore.power_status ? '通电' : '断电'}}</span>
          </div>
        </div>
