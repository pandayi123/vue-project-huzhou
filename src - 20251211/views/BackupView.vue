          ...
          <div class="detail-card">
            ...
            <div class="action-footer">
              ...
              <div class="reason-section" v-if="singleItem.group_status === '在位'">
                ...
                <el-select v-model="borrowReason" placeholder="请选择用途..." allow-create filterable
                  default-first-option class="cyber-select" popper-class="cyber-dropdown">
          ...
          <div class="batch-card">
            ...
            <div class="action-footer">
              ...
              <div class="reason-section" v-if="validItemsCount > 0">
                <div class="reason-label">领用用途 / Purpose</div>
                <el-select v-model="borrowReason" placeholder="请选择或直接输入用途..." allow-create filterable
                  default-first-option class="cyber-select" popper-class="cyber-dropdown">
                  <el-option v-for="opt in reasonOptions" :key="opt.value" :label="opt.label" :value="opt.value" />
                </el-select>
              </div>
...
const reasonOptions = [
  { value: '日常训练', label: '日常训练' },
  { value: '战备执勤', label: '战备执勤' },
  { value: '装备维护', label: '装备维护' },
  { value: '临时借用', label: '临时借用' }
]
